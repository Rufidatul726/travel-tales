...
export class WeatherService {
    ...
    async getGeneralWeatherInfo(weatherParamDto: WeatherParamDto): Promise<WeatherData> {
        try {

            const startDate = moment(weatherParamDto.start_date).toDate();
            const endDate = moment(weatherParamDto.end_date).toDate();
            ...
            const params = {
                latitude: weatherParamDto.latitude,
                longitude: weatherParamDto.longitude,
